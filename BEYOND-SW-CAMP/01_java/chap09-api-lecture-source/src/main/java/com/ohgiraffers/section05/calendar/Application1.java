...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("기준 시간(1978년 9시 0분 0초): " + new Date(0L));
        ...
        String todayFormat = sdf.format(today);                    // format은 Date형, Calendar형에서만 사용할 수 있음
...
//        java.sql.Date sqlDate2 = (java.sql.Date)today;               // 실제로는 sql.Date형이었던 날짜형을 util.Date형인
                                                                     // today에 담겨 있었다면 이 방법도 가능

        /* 설명. java.sql.Date -> java.util.Date */
        java.util.Date utilDate = sqlDate;                           // 다형성 적용되고 자동 업캐스팅이 가능하다, sql이 자식이고 util이 부모
