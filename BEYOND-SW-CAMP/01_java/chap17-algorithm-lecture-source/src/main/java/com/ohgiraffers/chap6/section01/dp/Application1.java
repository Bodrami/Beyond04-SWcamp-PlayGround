...
/* 필기. 복잡한 전체 문제를 작은 부분 문제에 대한 최적의 해결방법을 고안하여 해결하는 알고리즘이다.
...
public class Application1 {
    public static int solution(int N) throws Exception {
        ...
        /* 설명. 5킬로그램까지는 앞의 if문에서 처리 했기 때문에 6킬로그램부터(5킬로그램 이하는 1이 측정되어야 하므로 +1을 함)
        ...
        for (int i = 6; i <= N; i++) {
            ...
            /* 설명. 한 종류가 아닌 봉지들로 설탕을 처리하는 경우 */
                ...
                /* 설명. 3 또는 5 배수 구간이 아니지만 3 또는 5 킬로그램짜리 봉지를 하나 더 들고 갈 수 있는 경우라면(ex. 23kg) */
