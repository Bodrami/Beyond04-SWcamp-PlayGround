...
public class FileUploadController {
    ...
    /* 설명. build된 파일 업로드 할 경로를 가져오기 위해 ResourceLoder 의존성 주입 받기 */
    @Autowired
    ...
    public String singleFileUpload(@RequestParam MultipartFile singleFile,
        ...
        /* 설명. encType = "multipart/form-data" 형태로 넘어온 파일은 MultipartFile 타입으로 받게된다.*/
...
//        System.out.println("multiFileDescription = " + multiFileDescription);
        ...
        /* 설명. 사용자가 올린 파일들을 다 rename 하고 저장하는 작업 및 DB로 전달하기 위한 List에 쌓기 */
