...
public class ResponseEntityTestController {
    ...
    public ResponseEntityTestController() {
        ...
        users.add(new UserDTO(2, "user02", "pass02", "이브보라", new java.util.Date()));
    ...
    /* 설명. 기존에 우리가 배웠던 @RequestParam과 달리 json 문자열이 핸들러 메소드로 넘어올 때는 @RequestBody 를 붙이고
     *       받아내야 한다. json 문자열의 각 프로퍼티 별로 받을 수도 있지만 한번에 하나의 타입으로 다 받아낼 때는 커맨드 객체 (userDTO)
     *       를 활용해야 하며 커맨드 객체는 json 문자열의 프로퍼티명과 일치해야한다.
     *
     * 설명.
     *  {
     *     "id" : "user01"
