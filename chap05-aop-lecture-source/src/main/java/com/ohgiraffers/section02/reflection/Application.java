...
public class Application {
    public static void main(String[] args) {
         ...
         *
         * 필기. reflection 은 강력한 도구이지만 무분별하게 사용해선 안된다.
         *      1. 오버헤드 발생: 성능 저하를 발생할 수 있기 때문에 민감한 애플리케이션에서는 사용하지 않는다.
         *      2. 캡슐화 저해: private 로 설정한 member(또는 필드)에 접근 가능하기 때문에 코드 기능이 저하되며
         *                   여러 가지 문제를 야기할 수 있다. */

        /* 설명 1. Class 타입의 Class 메타정보 추출 (숨겨진 데이터들) */
        ...
        try {
            Account acc = (Account) constructors[0].newInstance("20", "110-223-1234445", "1234", 10000);
