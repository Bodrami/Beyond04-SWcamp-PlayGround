...
public class Application2 {
    ...
    public static void main(String[] args) {
       ...
       * */
        ...
        /* 필기. String 객체는 리터럴로 생성될 때는 heap영역의 상수풀(constant pool)에 생성된다.
        *       상수풀은 동등한 String 객체를 하나만 저장하는 (중복제거) 공간으로 동일한 String 변수를 효율적으로 사용할 수 있도록
        *       제공된다. (String의 equals()와 hashCode()를 통해 적용)*/
