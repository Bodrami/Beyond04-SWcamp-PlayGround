...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기. charAt(): 해당 문자열의 특정 인데스에 해당하는 문자를 반환한다.(인덱스 체계 0부터 시작) */
        String str1 = "apple";
        ...
        /* 필기. compareTo(): 인자로 전달된 문자열과 사전(아스키코드) 순으로 비교 */
        String str2 = "java";
        String str3 = "java";
        String str4 = "JAVA";
        String str5 = "mariaDB";
        ...
        /* 필기. indexOf(): 문자열에서 특정문자를 탐색하여 처음 일치하는 인덱스 위치를 정수형으로 반환한다.
         *       (일치하지 않으면 -1 반환)
        * */
        ...
        /* 필기. lastIndexOf(): 문자열 탐색을 뒤에서부터 하고 처음 일치하는 위치의 인덱스를 반환한다.
         *                     (일치하지 않으면 -1  반환)
        * */
        System.out.println("lastIndex('a'): " + indexOf.lastIndexOf('a'));
        System.out.println("lastIndex('z'): " + indexOf.lastIndexOf('z'));
        ...
        * */
        ...
        /* 필기. substring(): 문자열의 일부분을 잘라내어 새로운 문자열을 반환하다. */
        ...
        /* 필기. length(): 문자열의 길이를 정수형으로 반환하다. */
        System.out.println("length(): " + javamariaDB.length());
        System.out.println("빈 문자열 길이: " + "".length());               // 배열은 arr.length로 () 사용하지 않는다.

        /* 필기. isEmpty(): 문자열의 길이가 0이면 true를 반환, 아니면 false를 반환한다. (null과 다르다.) */
