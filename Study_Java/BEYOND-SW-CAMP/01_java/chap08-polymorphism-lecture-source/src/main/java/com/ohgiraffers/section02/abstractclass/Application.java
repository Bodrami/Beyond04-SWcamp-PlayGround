...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *       (단, 자식 클래스에서 객체가 생성 될 때는 내부적으로 생성될 수 있다.
        *
        * 필기. 메소드의 헤드부만 있고 바디부가 없는 메소드를 추상메소드라고 한다.
        *      쉽게 말해 불완전한 메소드를 하나라도 가진 클래스는 반드시 추상 클래스가 되어야 한다.
...
//        Product product = new Product();
        ...
        product.abstractMethod();               // 동적바인딩에 의한 자식 클래스의 오버라이딩 메소드 실행
    }
}
