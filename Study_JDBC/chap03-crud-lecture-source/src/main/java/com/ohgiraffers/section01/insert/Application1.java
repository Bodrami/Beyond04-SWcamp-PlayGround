...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명.
         *  DML(insert, update, delete) 작업 시에는 반환 결과가 int(영향을 받은 행의 수)값이 된다.(ResultSet을 쓰지 않는다.)
         *  ResultSet을 쓰지 않는 이유는 단일한 결과를 반환하기 때문에 사용하지 않는다.
        ...
        * */
        ...
        try {
            ...
            result = pstmt.executeUpdate();         // 자동 커밋 상태에서는 executeUpdate()하면 자동 커밋 되는 것을 방지하기 위해 수동 커밋 변환을 해주는 조건문
