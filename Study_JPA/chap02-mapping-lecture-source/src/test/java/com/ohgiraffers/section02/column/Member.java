...
public class Member {
    ...
    @Column(name = "phone", columnDefinition = "varchar(200) default '010-2939-1010'")
...
//    @Temporal(TemporalType.TIMESTAMP)   // DateTime 자료형으로 등록
    @Temporal(TemporalType.DATE)        // Date 자료형으로 등록
//    @Temporal(TemporalType.TIME)          // Time 자료형으로 등록
