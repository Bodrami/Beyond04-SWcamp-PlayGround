...
public class A_EntityLifeCycleTests {
    ...
    /* 필기. 영속성 컨텍스트는 엔티티 매니저가 엔티티 객체를 저장하는 공간으로 엔티티 객체를 보관하고 관리한다.
...
//        System.out.println("foundMenu = " + foundMenu);
        ...
        /* 설명. 영속 상태의 객체에서 값을 추출해 담더라도 새로 생성되어 영속성 컨텍스트와 관련 없는 비영속 상태이다. */
    ...
    public void 영속성_연속_조회_테스트() {
        ...
        boolean isTure = (foundMenu1 == foundMenu2);
    ...
    public void 영속성_객체_추가_테스트() {
        ...
        /* 설명. 이 예제에서는 menuCode 필드 값에 직접 값을 주고자 한다. (auto_increment 개념 안 쓸 예정)
         *      @GeneratedValue 부분을 주석하고 테스트를 작성하자.
        * */
        Menu menuToRegist = new Menu();
        menuToRegist.setMenuCode(500);
        menuToRegist.setMenuName("수박탕탕아");
        menuToRegist.setMenuPrice(10);
    ...
    public void 영속성_객체_추가_값_변경_테스트() {
        ...
        menuToRegist.setMenuCode(500);
        menuToRegist.setMenuName("수박탕탕아");
        menuToRegist.setMenuPrice(12000);
        menuToRegist.setCategoryCode(7);
        menuToRegist.setOrderableStatus("Y");
    ...
    // 개념적 이해를 돕기 위함으로 따로 사용하진 않지만 개념은 알아두자.
    @Test
    public void 준영속성_detach_테스트() {
        ...
        /* 설명. 영속성 컨텍스트가 관리하던 엔티티 객체를 관리하지 않는 상태가 되게 한 것을 준영속 상태라고 한다.
    ...
    public void 준영속성_clear_close_테스트() {
        ...
        /* 설명. 영속성 컨텍스트로 관리되던 엔티티 객체들을 모두 비영속 상태로 바꿈 (clear 사용 시) */
//        entityManager.clear();

        /* 설명. 영속성 컨텍스트 및 엔티티 매니저까지 종료해 버린다. (사용 불가, close 사용 시)*/
        entityManager.close();
